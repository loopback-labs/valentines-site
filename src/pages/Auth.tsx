    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-gradient-love relative overflow-hidden">
      ...
      <Card className="w-full max-w-md z-10 shadow-2xl border-0 backdrop-blur-sm bg-card/95">
        <CardHeader className="text-center pb-2">
          <CardTitle className="text-2xl font-bold text-gradient-love bg-clip-text">Create Magic ✨</CardTitle>
          ...
          <Tabs defaultValue="login" className="w-full">
            ...
            <TabsContent value="login">
              <div className="space-y-4">
                <GoogleAuthSection onGoogleClick={handleGoogleSignIn} disabled={isLoading} />
      ...
      <p className="mt-6 text-white/80 text-sm z-10">Made with 💕 for spreading love</p>
    </div>
  );
}
